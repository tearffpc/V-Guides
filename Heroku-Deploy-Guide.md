...
- 🎵️ Music 🎵️
- 💫 Chill 💫
1. [Chizuru](https://github.com/nexusNw/Chizuru) - Go there
...
`CHAT_BOT_URL` A BOT WITH A BRAIN ROCKS! Click=> [Get ChatBot Url](https://github.com/tearffpc/V-Guides/blob/main/Chat_Bot_Url.md)<br>
...
`MODS` The phone numbers of users who you want to be the bot's Admins separated by a comma and must the numbers must be in the following format: `[cc][number]`. eg: `91812*******`<br>
`MONGO_URI` is the Connection URL to your DB ([Mongo-Atlas-Guide](https://github.com/tearffpc/V-Guides/blob/main/Mongo-Atlas-guide.md))<br>
